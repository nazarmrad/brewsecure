...
const products = [
  // Light Roast
  {
    ...
    price: 18.99,
    imageUrl: 'https://brewsecure-imagesv2.es-mad-1.linodeobjects.com/Yirgacheffe.png',
    stock: 120,
    category: 'Light',
    badge: 'Single Origin',
    rating: 4.8,
  ...
  },
  {
    ...
    price: 21.50,
    imageUrl: 'https://brewsecure-imagesv2.es-mad-1.linodeobjects.com/Kirinyaga.png',
    stock: 85,
    category: 'Light',
    badge: 'Award Winner',
    rating: 4.9,
  ...
  },
  {
    ...
    price: 34.00,
    imageUrl: 'https://brewsecure-imagesv2.es-mad-1.linodeobjects.com/Boquete.png',
    stock: 40,
    category: 'Light',
    badge: 'Rare',
    rating: 5.0,
  ...
  // Medium Roast
  {
    ...
    price: 16.50,
    imageUrl: 'https://brewsecure-imagesv2.es-mad-1.linodeobjects.com/Huila.png',
    stock: 200,
    category: 'Medium',
    badge: 'Best Seller',
    rating: 4.7,
  ...
  },
  {
    ...
    price: 17.00,
    imageUrl: 'https://brewsecure-imagesv2.es-mad-1.linodeobjects.com/Antigua.png',
    stock: 150,
    category: 'Medium',
    badge: null,
    rating: 4.6,
  ...
  },
  {
    ...
    price: 19.00,
    imageUrl: 'https://brewsecure-imagesv2.es-mad-1.linodeobjects.com/Tarrazu.png',
    stock: 110,
    category: 'Medium',
    badge: 'New Arrival',
    rating: 4.7,
  ...
  // Dark Roast
  {
    ...
    price: 15.99,
    imageUrl: 'https://brewsecure-imagesv2.es-mad-1.linodeobjects.com/Sumatra.png',
    stock: 175,
    category: 'Dark',
    badge: null,
    rating: 4.5,
  ...
  },
  {
    ...
    price: 14.50,
    imageUrl: 'https://brewsecure-imagesv2.es-mad-1.linodeobjects.com/FrenchRoast.png',
    stock: 220,
    category: 'Dark',
  ...
  },
  {
    ...
    price: 20.00,
    imageUrl: 'https://brewsecure-imagesv2.es-mad-1.linodeobjects.com/Sulawesi.png',
    stock: 60,
    category: 'Dark',
    badge: 'Rare',
    rating: 4.6,
  ...
  // Blends
  {
    ...
    price: 13.99,
    imageUrl: 'https://brewsecure-imagesv2.es-mad-1.linodeobjects.com/HouseBlend.png',
    stock: 300,
    category: 'Blends',
    badge: 'House Blend',
    rating: 4.5,
  ...
  },
  {
    ...
    price: 14.99,
    imageUrl: 'https://brewsecure-imagesv2.es-mad-1.linodeobjects.com/RitualBlend.png',
    stock: 250,
    category: 'Blends',
  ...
  },
  {
    ...
    price: 15.50,
    imageUrl: 'https://brewsecure-imagesv2.es-mad-1.linodeobjects.com/EspressoBlend.png',
    stock: 190,
    category: 'Blends',
    badge: 'Barista Pick',
    rating: 4.7,
