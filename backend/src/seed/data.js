...
// ── Products ───────────────────────────────────────────────────────────────────
const IMG = process.env.IMAGE_BASE_URL || 'http://localhost:3001/images'
...
const products = [
  ...
  },
  {
    ...
    price: 15.50,
    imageUrl: `${IMG}/EspressoBlend.png`,
    stock: 190,
    category: 'Blends',
    badge: 'Barista Pick',
    rating: 4.7,
